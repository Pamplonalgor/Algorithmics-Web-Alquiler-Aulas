      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16 mt-12 md:mt-16">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left flex flex-col items-center md:items-start">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight text-[#2d1b4e] mb-6">
            ...
            <div className="flex flex-col items-center md:items-start gap-5 mt-2">
              <Link href="/contacto" className="group text-xl font-bold text-[#2d1b4e] hover:text-slate-600 transition-colors">
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col lg:flex-row gap-6 mb-6">
            ...
            <div className="w-full lg:w-[40%] lg:sticky lg:top-32 self-start bg-transparent flex items-center justify-center pt-8">
              <div className="relative w-full max-w-[450px] aspect-[4/5] lg:aspect-[2/3]">
                {/* Photo 1 (Top Left) */}
                <div className="absolute top-[0%] left-[0%] w-[60%] aspect-[4/5] rounded-[2rem] overflow-hidden shadow-lg border-[6px] border-[#FCF9F2] z-20 hover:scale-105 transition-transform duration-300">
                  <Image src="/senior_mobile_v2.png" alt="Persona usando móvil" fill className="object-cover" />
                </div>
                {/* Photo 3 (Middle Right) */}
                <div className="absolute top-[45%] right-[0%] w-[60%] aspect-[3/4] rounded-[2rem] overflow-hidden shadow-lg border-[6px] border-[#FCF9F2] z-10 hover:scale-105 transition-transform duration-300">
                  <Image src="/senior_group_v2.png" alt="Grupo en clase" fill className="object-cover" />
                </div>
                {/* Photo 2 (Bottom Left) */}
                <div className="absolute bottom-[-20%] left-[5%] w-[70%] aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border-[6px] border-[#FCF9F2] z-30 hover:scale-105 transition-transform duration-300">

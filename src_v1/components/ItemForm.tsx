    ...
    <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-xl z-[9999] flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 p-8 md:p-12 rounded-[3rem] max-w-2xl w-full my-auto shadow-2xl animate-fade-in-up relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              ...
              <input 
                ...
                className="bg-slate-950 border border-slate-800 p-5 rounded-2xl focus:border-amber-500 outline-none transition-all text-white"
              />
            </div>
            ...
            {type === 'aulas' && (
              <div className="flex flex-col gap-3">
                ...
                <input 
                  ...
                  value={formData.size || ''}
                  onChange={handleInputChange} 
                  className="bg-slate-950 border border-slate-800 p-5 rounded-2xl focus:border-amber-500 outline-none text-white" 
                />
              </div>
            )}
          </div>
          ...
          {type === 'aulas' && (
            <div className="grid grid-cols-2 gap-8 bg-amber-500/5 p-6 rounded-3xl border border-amber-500/10">
              <div className="flex flex-col gap-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-500 ml-2">Precio Media Jornada (€)</label>
                <input 
                  type="number" 
                  name="price_half" 
                  step="0.01"
                  ...
                  onChange={handleInputChange} 
                  className="bg-slate-950 border border-slate-800 p-5 rounded-2xl focus:border-amber-500 outline-none text-white font-bold" 
                />
              </div>
              <div className="flex flex-col gap-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-500 ml-2">Precio Jornada Completa (€)</label>
                <input 
                  type="number" 
                  name="price_full" 
                  step="0.01"
          ...
          {type === 'aulas' && (
            <div className="space-y-6 bg-slate-950/50 p-8 rounded-[2rem] border border-slate-800">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <label className="flex items-center gap-4 p-5 bg-slate-900 rounded-3xl border border-slate-800 cursor-pointer hover:border-amber-500/50 transition-all">
                  <input 
                    type="checkbox" 
                    ...
                    className="w-6 h-6 rounded-lg bg-slate-950 accent-amber-500"
                  />
          ...
          <div className="flex flex-col gap-3">
            ...
            <textarea 
              ...
              onChange={handleInputChange} 
              className="bg-slate-950 border border-slate-800 p-5 rounded-2xl focus:border-amber-500 outline-none transition-all w-full text-white resize-none" 
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <input 
              ...
              className="bg-slate-950 border border-slate-800 p-5 rounded-2xl file:bg-amber-500 file:text-slate-950 file:border-none file:px-6 file:py-2 file:rounded-xl file:mr-6 file:font-black file:cursor-pointer text-slate-500 text-sm"
            />
          ...
          <div className="flex gap-6 pt-6">
            ...
            <button 
              ...
              className="flex-1 px-8 py-5 bg-amber-500 text-slate-950 rounded-2xl font-black hover:bg-amber-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-amber-500/20"
            >
